...
<template>
  <div class="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] px-4">
    <!-- Mensaje de bienvenida si está logueada -->
    ...
    <!-- Hero principal -->
    <div
      class="w-full max-w-4xl py-16 px-6 md:px-10 rounded-3xl bg-[radial-gradient(circle_at_top,_#7f1d1d,_#020617)] shadow-xl flex flex-col items-center text-center gap-4"
    >
      <h1 class="text-3xl md:text-4xl font-bold tracking-wide text-red-400 drop-shadow-lg">
        Watch. Rate. Debate.
      </h1>
      <h3
        class="text-lg md:text-2xl font-medium text-red-100 drop-shadow"
      >
