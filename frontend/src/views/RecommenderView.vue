    ...
    <div class="relative z-10 content-wrap mx-auto max-w-[720px] px-6 pt-20 pb-12">
      ...
      <div v-if="step === 0" class="flex flex-col items-center justify-center text-center min-h-[calc(100vh-10rem)] gap-10 animate-fade-in">
        ...
        <div class="relative flex items-center justify-center w-28 h-28">
          <div class="absolute w-28 h-28 rounded-full bg-yellow-500/20 blur-2xl"></div>
          <div class="relative w-24 h-24 rounded-full bg-yellow-500/10 border-2 border-yellow-500/40 flex items-center justify-center shadow-[0_0_40px_rgba(234,179,8,0.2)]">
